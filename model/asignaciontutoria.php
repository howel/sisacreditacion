...
//    echo "delete from detalle_asignacion_tutoria where detalle_asignacion_tutoria.CodigoProfesor='".$_P['CodigoProfesor']."' and detalle_asignacion_tutoria.CodigoSemestre='".$sem."'";exit;
