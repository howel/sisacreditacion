...
class evento extends Main{    
 ...
 Inner Join clasificacion_evento ON clasificacion_evento.id_clasificacion_evento = tipo_evento.id_clasificacion_evento
    where  evento.CodigoSemestre='".$semestre_ultimo."'and  clasificacion_evento.id_clasificacion_evento=1  AND evento.CodigoProfesor='".$cod_profesor."' OR  evento.CodigoProfesor is NULL  
                        and " . $c . " like :query";       
