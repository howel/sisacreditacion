...
class asistenciadocente extends Main {
    ...
    function index($query, $p, $c,$semestre_ultimo) {
        ...
        $sql = "        SELECT
                        ...
                        FROM
                        tipo_evento
                        Inner Join evento ON evento.idtipo_evento = tipo_evento.idtipo_evento and evento.CodigoProfesor is null
                        where    evento.CodigoSemestre='".$semestre_ultimo."'and evento.idtipo_evento=1 and " . $c . " like :query";
