...
<div class="container-fluid">   
    <div class="row">  
        <div  class="col-sm-12 col-md-12 ">
            <div id="alumnos">
            <iframe id="iframe_buscar_alumno"src="index.php?controller=alumno&action=search_por_facultad&fac=<?php echo $idfacultad;?>&sinCab=true" width="900" height="480"  marginwidth="0" noresize scrolling="No" frameborder="0">
