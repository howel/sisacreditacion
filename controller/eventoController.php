...
class eventoController extends Controller {    
    public function index() 
    {
        ...
        $opt = array("evento.Tema"=>"Tema","evento.fecha"=>"Fecha ");
...
//        $dep=$this->mostrar_Facultad_idUsusario($_SESSION['idusuario']);
        if($_SESSION['idperil']==4){$WHERE=" where tipo_evento.idtipo_evento= '2' or tipo_evento.idtipo_evento='1'";} ;
        $data['tipo_evento'] = $this->Select(array('id'=>'idtipo_evento','name'=>'idtipo_evento','table'=>"tipo_evento ".$WHERE,'code'=>$obj->idtipo_evento));
        $view->setData($data);
        $view->setTemplate( '../view/evento/_Form.php' );
        $view->setLayout( '../template/Layout.php' );
        $view->render();
