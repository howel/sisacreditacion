...
class alumnoController extends Controller {
    ...
    public function index() {
        ...
        $opt = array("NombreAlumno" => "Nombre Alumno", "CodAlumnoSira" => "Codigo Sira ");//busqueda filtros

        $data['grilla'] = $this->grilla("alumno", $cols, $data['data']['rows'], $opt, $data['pag'], true, true,false,true);
    ...
    {  
       ...
       if (!isset($_GET['criterio'])) {
        ...
        $opt = array("NombreAlumno" => "Nombre Alumno", "CodAlumnoSira" => "Codigo Sira ");
         $data['grilla'] = $this->grilla("alumno", $cols, $data['data']['rows'], $opt, $data['pag'], false, false,true,false,false,false,false,true);
